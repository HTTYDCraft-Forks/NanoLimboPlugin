...
import com.httydcraft.limbo.command.LampVelocityCommandHandler;
import com.httydcraft.limbo.config.LimboConfig;
import com.httydcraft.limbo.config.model.VelocityLimboServer;
...
@Plugin(id = "nanolimbovelocity", name = "NanoLimboVelocity", version = "1.0.11", authors = "httydcraft, Nan1t")
